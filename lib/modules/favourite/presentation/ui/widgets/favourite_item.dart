...
class FavouriteProductItem extends StatefulWidget {
  const FavouriteProductItem({super.key});

  @override
  State<FavouriteProductItem> createState() => _ProductItemState();
}

class _ProductItemState extends State<FavouriteProductItem> {
