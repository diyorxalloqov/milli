...
class TopCategory3 extends StatefulWidget {
  const TopCategory3({super.key});

  @override
  State<TopCategory3> createState() => _TopCategory2State();
}

class _TopCategory2State extends State<TopCategory3> {
  bool _isLiked = false;
  @override
